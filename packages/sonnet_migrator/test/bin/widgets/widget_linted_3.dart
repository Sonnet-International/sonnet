  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // inner interpolation
        Text(
          context.sonnet.interpolationInterpolation(context.sonnet.outerInnerInterpolation(1 == 1 ? context.sonnet.somelocalstring(true == false ? 'foo' : 'bar') : context.sonnet.inner)),
        ),
        Text(
          context.sonnet.interpolationInterpolation(context.sonnet.outerInnerInterpolation(1 == 1 ? context.sonnet.somelocalstring(true == false ? 'foo' : 'bar') : context.sonnet.inner)),
        ),
