  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // inner interpolation
        Text(
          context.sonnet.interpolationInterpolation(context.sonnet.outerInnerInterpolation(1 == 1 ? context.sonnet.somelocalstring(true == false ? context.sonnet.foo : context.sonnet.bar) : context.sonnet.inner)),
        ),
        Text(
          context.sonnet.interpolationInterpolation(context.sonnet.outerInnerInterpolation(1 == 1 ? context.sonnet.somelocalstring(true == false ? context.sonnet.foo : context.sonnet.bar) : context.sonnet.inner)),
        ),
        ...
        Text(
          context.sonnet.otherLastOfAll(context.sonnet.interpolated1Other((manyArgs(arg1: context.sonnet.argument1, arg2: context.sonnet.argument2, arg3: context.sonnet.argument1)).toString())),
