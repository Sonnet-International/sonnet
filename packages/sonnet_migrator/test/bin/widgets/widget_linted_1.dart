...
import 'package:flutter_gen/gen_l10n/sonnet_localizations.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(context.sonnet.trueAsTrueCouldBe('true')),
        Text(context.sonnet.trueAsTrueCouldBe('true')),
        ...
        Text(context.sonnet.nullableStringPlusOtherOther(nullableString ?? 'other')),
        Text(context.sonnet.nullableStringPlusOtherOther(nullableString ?? 'other')),
        ...
        Text(context.sonnet.rawRawRaw(r'tis $ raw', r'tis $ raw', 'tis \$ raw')),
        Text(context.sonnet.rawRawRaw(r'tis $ raw', r'tis $ raw', 'tis \$ raw')),
        ...
        // inner interpolation
        Text(
          context.sonnet.interpolationInterpolation('outer ${1 == 1 ? '${true == false ? 'foo' : 'bar'}' : 'inner'} interpolation'),
        ),
        Text(
          context.sonnet.interpolationInterpolation('outer ${1 == 1 ? '${true == false ? 'foo' : 'bar'}' : 'inner'} interpolation'),
        ),
        ...
        Text(
          context.sonnet.otherLastOfAll('interpolated ${manyArgs(arg1: 'argument 1', arg2: 'argument.2', arg3: 'argument 1')} other'),
